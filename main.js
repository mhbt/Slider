...
if(document.querySelector(".slider-container")) {
  ...
  var controlLeft = document.querySelector("#slider-fruit .slider-control-left button");
  var controlRight = document.querySelector("#slider-fruit .slider-control-right button");
  var slide_content = document.querySelectorAll("#slider-fruit .slider-content");
